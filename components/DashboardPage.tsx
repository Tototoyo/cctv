    ...
    return (
        <div className="max-w-7xl mx-auto animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                <h1 className="text-4xl md:text-5xl font-bold text-slate-100 tracking-wide">My Prompts</h1>
            ...
            <div className="bg-gray-900/50 border border-green-400/10 rounded-sm p-6">
                <h2 className="text-2xl font-bold text-green-400 mb-6">My Saved Prompts</h2>
                {isLoading ? (
                    ...
                    <div className="text-center text-slate-500 border-2 border-dashed border-slate-800 rounded-sm p-12">
                        ...
                        <p className="mt-1 text-sm">The prompts you generate are automatically saved here.</p>
                    </div>
                )}
            </div>
        </div>
