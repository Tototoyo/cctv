...
type NavPage = 'generator' | 'about' | 'contact' | 'terms' | 'privacy' | 'auth' | 'dashboard' | 'gallery' | 'blog';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <nav className="hidden md:flex items-center space-x-2">
              ...
              <NavLink href="#blog" onClick={(e) => handleNavClick(e, 'blog')}>Blog</NavLink>
            </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden" id="mobile-menu">
            <nav className="space-y-1 px-2 pt-2 pb-3">
              ...
              {user ? (
                  <>
                    <NavLink href="#" onClick={(e) => handleNavClick(e, 'dashboard')}>My Prompts</NavLink>
