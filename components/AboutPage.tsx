  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="space-y-6 text-slate-300 text-lg leading-relaxed">
        ...
        <p>
          This application is powered by <span className="text-green-400 font-semibold">OpenAI's powerful language models</span>, leveraging their advanced generative capabilities to produce creative and contextually accurate scene descriptions based on your inputs.
        </p>
        <p>
