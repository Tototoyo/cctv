  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="space-y-6 text-slate-300 text-lg leading-relaxed">
        ...
        <p>
          The Service is a tool that uses OpenAI's API to generate text-based prompts for creative and developmental purposes. The content generated is produced by an artificial intelligence model and may not always be accurate, appropriate, or complete.
        </p>
